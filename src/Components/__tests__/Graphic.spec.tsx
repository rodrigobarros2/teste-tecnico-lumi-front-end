...
import { compareDatesChronologically, calculateCompensatedEnergyKWh } from "../../utils/__tests__/mocks";
...
vi.mock("../../utils/compareDatesChronologically", () => ({
  compareDatesChronologically,
}));

vi.mock("../../utils/calculateCompensatedEnergy", () => ({
  calculateCompensatedEnergyKWh,
}));
...
describe("Home Component", () => {
  ...
  test("should render the graphic component correctly", () => {
    mockUseUserData.mockReturnValue({
      users: ["12345", "67890"],
      setUsers: vi.fn(),
      handleUserDataById: vi.fn(),
      userSelected: [
        {
          ...
          electricity: [{ quantity: "1000", value: "150,00" }],
          injectedEnergy: [{ quantity: "500", value: "50,00" }],
          contributionPublicLighting: "30,00",
          compensatedEnergy: [{ value: "20,00" }],
        },
      ],
      numberClient: "12345",
      handleGetUsers: vi.fn(),
